<?php
    ...
    if(isset($_POST["update"])){
      ...
      $mySQL= "UPDATE logs
               SET employee_id= '$employee_id' log_date='$log_date' login_time='$login_time', logout_time='$logout_time',
               WHERE employee_id= '$oemployee_id' AND log_date='$olog_date' AND login_time='$ologin_time', AND logout_time='$ologout_time'";
      ...
      $_SESSION['message'] = "Edit Record Successlly Logins:  $log_date, $login_time, $logout_time";
...
<html lang="en">
	...
	<div>
        ...
        <div class="form-group row">
            <label class="col-sm-2">logout_time</label>
